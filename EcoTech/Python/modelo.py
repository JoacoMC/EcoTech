...
class Empleado:
    def __init__(self, id_empleado:int, nombre: str, direccion: str, telefono: str, correo: str, inicio_contrato: date, salario:int, Departamento.id_departamento : int) -> None:
        self.id_empleado = id_empleado
        self.nombre = nombre
