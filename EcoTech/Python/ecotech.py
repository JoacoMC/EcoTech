...
class Aplicacion():
    ...
    def nuevo_usuario(self):
        ...
        self.empleados_cmb = Combobox(self.nuevo_usuario_frame)
        self.empleados_cmb.grid(row=3, column=1, padx=10, pady=10)
    ...
    def cargar_empleados(self):
        ...
        self.empleados_cmb['values'] = values
    ...
    def ingresarusuario(self):
        try:
            ...
            indice = self.empleados_cmb.current()
            item:str = self.empleados_cmb['values'][indice]
            id_empleado = CrudEmpleado().buscar_por_nombre(item)
            if not isinstance(id_empleado, int):
                messagebox.showerror("Error", "No se pudo obtener un ID de empleado válido.")
                return
            id_usuario = CrudUsuario().obtener_ultima_id() +1
            nuevo= Usuario(id_usuario, nombre, contraseña, permiso, id_empleado)
            CrudUsuario().insertar(nuevo)
            messagebox.showinfo("Nuevo usuario", "Ingreso exitoso")
        except:
            messagebox.showerror("Nuevo usuario", "Error en ingreso")
    ...
    def buscar_usuario(self):
        try:
            indice = self.usuario_cmb.current()
            item:str = self.usuario_cmb['values'][indice]
            id_buscar = CrudUsuario().buscar_por_nombre(item)
            try:
            ...
            if usuario is None:
                ...
                self.nombre_ety.insert(0, usuario[0])
                self.nombre_ety.grid(row=0, column=1, padx=10, pady=10)

                tk.Label(self.detalle_usuario_frame, text="Contraseña").grid(row=1, column=0, padx=10, pady=10)
                self.contraseña_ety = tk.Entry(self.detalle_usuario_frame, show='*')
                self.contraseña_ety.insert(0, usuario[1])
                self.contraseña_ety.grid(row=1, column=1, padx=10, pady=10)
                ...
                self.permiso_ety.insert(0, usuario[2])
                self.permiso_ety.grid(row=2, column=1, padx=10, pady=10)
                # Botón de ingresos
    ...
    def update_usuario(self):
        try:
            ...
            indice = self.usuario_cmb.current()
            item:str = self.usuario_cmb['values'][indice]
            id_usuario = CrudUsuario().buscar_por_nombre(item)
    ...
    def eliminar_usuario(self):
        ...
        self.usuario_cmb = Combobox(self.eliminar_usuario_frame, state="readonly")
        self.usuario_cmb.grid(row=0, column=1, padx=10, pady=10)
        self.cargar_usuarios()
        # Botón de ingresos
    ...
    def actualizar_empleados(self) -> None:
        ...
        for empleado in empleados:
            self.empleados_tbl.insert("", "end", values=(empleado.nombre, empleado.direccion, empleado.telefono, empleado.correo, empleado.inicio_contrato, empleado.salario, empleado.id_departamento))
    ...
    def nuevo_empleado(self):
        ...
        self.departamento_cmb = Combobox(self.nuevo_empleado_frame)
        self.departamento_cmb.grid(row=6, column=1, padx=10, pady=10)
    ...
    def cargar_departamentos(self):
        ...
        for c in departamentos:
            values.append("{}".format(c.nombre))
        self.departamento_cmb['values'] = values
    ...
    def ingresarempleado(self):
        try:
            ...
            indice = self.departamento_cmb.current()
            item:str = self.departamento_cmb['values'][indice]
            id_buscar = CrudDepartamento().buscar_por_nombre(item)
            ...
            try:
                salario = int(salario)
                departamento = int(id_buscar)
            except ValueError:
                messagebox.showerror("Error", "Salario y Departamento deben ser números.")
                return
            id_empleado = CrudEmpleado().obtener_ultima_id()
            nuevo_empleado = Empleado(id_empleado, nombre, direccion, telefono, correo, inicio_contrato, salario, departamento)
    ...
    def modificar_empleado(self):
        ...
        self.empleados_cmb = Combobox(self.modificar_empleado_frame)
        self.empleados_cmb.grid(row=0, column=1, padx=10, pady=10)
        self.cargar_empleados()
        # Botón de ingresos
    ...
    def buscar_empleado(self):
        try:
            indice = self.empleados_cmb.current()
            item:str = self.empleados_cmb['values'][indice]
            id_buscar = CrudEmpleado().buscar_por_nombre(item)
            ...
            if empleado is None:
                ...
                self.nombre_ety.grid(row=0, column=1, padx=10, pady=10)
                self.nombre_ety.insert(0, empleado[0])
                ...
                self.direccion_ety.grid(row=1, column=1, padx=10, pady=10)
                self.direccion_ety.insert(0, empleado[1])
                ...
                self.telefono_ety.grid(row=2, column=1, padx=10, pady=10)
                self.telefono_ety.insert(0, empleado[2])
                ...
                self.correo_ety.grid(row=3, column=1, padx=10, pady=10)
                self.correo_ety.insert(0, empleado[3])
                ...
                self.inicio_contrato_ety.grid(row=4, column=1, padx=10, pady=10)
                self.inicio_contrato_ety.insert(0, empleado[4])
                ...
                self.salario_ety.grid(row=5, column=1, padx=10, pady=10)
                self.salario_ety.insert(0, empleado[5])
                
                tk.Label(self.detalle_empleado_frame, text="Departamento").grid(row=6, column=0, padx=10, pady=10)
                self.departamento_cmb = Combobox(self.detalle_empleado_frame)
                self.departamento_cmb.grid(row=6, column=1, padx=10, pady=10)
                self.cargar_departamentos()
    ...
    def update_empleado(self):
        try:
            ...
            indice = self.departamento_cmb.current()
            item:str = self.departamento_cmb['values'][indice]
            id_departamento = CrudDepartamento().buscar_por_nombre(item)
            indice1 = self.empleados_cmb.current()
            item1:str = self.empleados_cmb['values'][indice1]
            id_empleado = CrudEmpleado().buscar_por_nombre(item1)
            try:
                inicio_contrato = datetime.strptime(inicio_contrato, "%Y-%m-%d")
            except ValueError:
                messagebox.showerror("Error", "Fecha de inicio de contrato inválida. Use el formato YYYY-MM-DD.")
            ...
            try:
                ...
                messagebox.showerror("Error", "Salario debe ser número.")
                return
            nuevo_empleado = Empleado(id_empleado, nombre, direccion, telefono, correo, inicio_contrato, salario, id_departamento)
            success, message = CrudEmpleado().modificar(nuevo_empleado, id_empleado)
    ...
    def eliminar_empleado(self):
        ...
        self.empleados_cmb = Combobox(self.eliminar_empleado_frame)
        self.empleados_cmb.grid(row=0, column=1, padx=10, pady=10)
        self.cargar_empleados()
        # Botón de ingresos
